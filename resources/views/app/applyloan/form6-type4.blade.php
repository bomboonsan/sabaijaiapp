            ...
            <div class="p-5 md:p-10">
                ...
                <form class="education-form"><form class="education-form" action="{{ route('loan-form6submit') }}" method="POST">
                    ...
                    <div>
                        ...
                        <select id="type_business_detail" class="w-full" name="type_business_detail">
                    ...
                    <div>
                        ...
                        <div id="monthly_profit" class="flex gap-3">
                            <input class="flex-1" type="number" name="monthly_profit" min="0" @if(isset($data['monthly_profit'])) value="{{ $data['monthly_profit'] }}" @endif />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="number_of_employees" class="flex gap-3">
                            <input class="flex-1" type="number" name="number_of_employees" min="0" @if(isset($data['number_of_employees'])) value="{{ $data['number_of_employees'] }}" @endif />
                        </div>
                    </div>
                    <div>
